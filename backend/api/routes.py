...
def generate_research_report(final_state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Extract executive summary from final report or generate one
    executive_summary = final_state.get("final_report", "Comprehensive research report generated by Deep Research AI Agent")
    if isinstance(executive_summary, dict):
        executive_summary = executive_summary.get("content", str(executive_summary))
