...
def generate_research_report(final_state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "executive_summary": "Comprehensive research report generated by Deep Research AI Agent",
        "key_findings": final_state.get("verified_facts", []),
        "risk_assessment": final_state.get("risks_flagged", []),
        ...
        "research_metadata": {
            ...
            "total_facts": len(final_state.get("verified_facts", [])),
            "total_risks": len(final_state.get("risks_flagged", []))
        },
